...
$sqlpost = "SELECT t.topic_id,t.topic_subject,p.post_content
                FROM
                    topics t, posts p
                WHERE
                    t.topic_id=p.post_topic
					group by(t.topic_id)
					order by t.topic_date,p.post_date desc  LIMIT $start, $perpage"; 
            ...
            <div class="headernav">
                <div class="container">
                    <div class="row">
                        ...
                        <!--   
						   <div class="dropdown">
                                <a data-toggle="dropdown" href="#" >Connexion - Compte</a> <b class="caret"></b>
                       ...
                       -->
					   <a href="#">sign in</a> | <a href="new_account.php">créer nouveau compte</a>
...
/*dynamiser 0 post:en cours */
 ...
 while($rowpost = mysql_fetch_assoc($resultpost))
  ...
  <h2><a href=\"02_topic.html\">".$rowpost["topic_subject"]."</a></h2>
